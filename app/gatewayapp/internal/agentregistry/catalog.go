...
var catalogPolicies = map[string]catalogPolicy{
	...
	"codefree-o": {Priority: 80, Preferred: controlagents.LauncherChoiceInstalled},
}
...
var installedConnectableAgents = []struct {
	...
	},
	{
		Agent: ConnectableAgent{
			...
			Description: "Use the locally installed CodeFree-O ACP agent",
		},
		Config: nativeACPAgentConfig("codefree-o", "CodeFree-O ACP agent", "codefree-o", "acp"),
	},
	{
		Agent: ConnectableAgent{
