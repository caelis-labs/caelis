...
// configuration is sampled through an independent source at activation; the
// Registry owns Session Runtime activation, release, and collective shutdown.
// The package exposes focused Host services to its private AppServer composition
// and product capabilities through control/appserver; presentation Surfaces
