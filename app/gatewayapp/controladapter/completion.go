...
var errCompletionStopped = errors.New("app/gatewayapp/controladapter: completion stopped")
...
func enrichResumeCandidate(summary session.SessionSummary) controlprompt.ResumeCandidate {
