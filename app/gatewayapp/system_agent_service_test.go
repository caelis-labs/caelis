...
func TestAgentBindingServicePersistsSystemBindingForFutureReviewerAssembly(t *testing.T) {
...
func TestSystemAgentReasoningModelOverridesRequestMetadata(t *testing.T) {
	t.Parallel()
