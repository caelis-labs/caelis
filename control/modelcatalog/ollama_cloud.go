...
// ollamaCloudModels is the curated frontier catalog shown by Ollama App. The
// public /api/tags directory is broader and does not publish maximum output or
// per-model effort metadata, so it is not used as the selectable Cloud catalog.
