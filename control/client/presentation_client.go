...
type PresentationService interface {
	...
	SetPresentationMode(context.Context, Principal, SetPresentationModeRequest) error
	SetPresentationConfig(context.Context, Principal, SetPresentationConfigRequest) ([]PresentationConfigOption, error)
	SetPresentationModel(context.Context, Principal, SetPresentationModelRequest) error
}
...
type PresentationClient interface {
	...
	SetPresentationMode(context.Context, SetPresentationModeRequest) error
	SetPresentationConfig(context.Context, SetPresentationConfigRequest) ([]PresentationConfigOption, error)
	SetPresentationModel(context.Context, SetPresentationModelRequest) error
}
...
func (c *boundPresentationClient) SetPresentationMode(ctx context.Context, req SetPresentationModeRequest) error {
	return c.service.SetPresentationMode(ctx, c.principalCopy(), req)
}
func (c *boundPresentationClient) SetPresentationConfig(ctx context.Context, req SetPresentationConfigRequest) ([]PresentationConfigOption, error) {
	return c.service.SetPresentationConfig(ctx, c.principalCopy(), req)
}
func (c *boundPresentationClient) SetPresentationModel(ctx context.Context, req SetPresentationModelRequest) error {
	return c.service.SetPresentationModel(ctx, c.principalCopy(), req)
}
