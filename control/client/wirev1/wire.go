...
func marshalWireValueUnchecked(value any) ([]byte, error) {
	...
	case controlclient.DeleteModelRequest:
		return marshalWriteRequest(typed, typed.ExpectedRevision)
	case controlclient.SandboxRequest:
		return marshalWriteRequest(typed, typed.ExpectedRevision)
	case controlclient.HandoffAgentRequest:
		return marshalWriteRequest(typed, typed.ExpectedRevision)
...
func marshalDisconnectCandidatesSnapshot(snapshot controlclient.DisconnectCandidatesSnapshot) ([]byte, error) {
