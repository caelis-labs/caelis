...
// Session feed, independent Task observation, approval recovery, and the
// durable operation ledger. Surfaces bind this complete boundary without
// defining a second command, replay, or permission path.
//
