...
// Disconnector is the surface-neutral presentation capability for listing and
// disconnecting external ACP Agents. Product mutation authority remains the
// principal-bound AppServer command used by its implementation.
