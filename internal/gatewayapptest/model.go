...
func BindAgentBinding(ctx context.Context, stack *gatewayapp.Stack, binding agentbinding.Binding) (agentbinding.Status, error) {
	...
	result, err := stack.AgentCommands().BindAgentBinding(ctx, controlclient.Principal{ID: stack.UserID}, controlclient.BindAgentBindingRequest{
...
func CreateAgentRole(
	...
	result, err := stack.AgentCommands().CreateAgentRole(ctx, controlclient.Principal{ID: stack.UserID}, controlclient.CreateAgentRoleRequest{
		WriteBase: controlclient.WriteBase{
...
func UseHostModel(ctx context.Context, stack *gatewayapp.Stack, alias string) error {
	...
	result, err := stack.ConfigurationCommands().UseModel(ctx, controlclient.Principal{ID: stack.UserID}, controlclient.UseModelRequest{
		WriteBase: controlclient.WriteBase{
...
func connectConfig(cfg gatewayapp.ModelConfig) controlclient.ConnectConfig {
	return controlclient.ConnectConfig{
