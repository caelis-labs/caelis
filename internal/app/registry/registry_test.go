...
func TestDefaultRegistryCreatesOpenAICompatibleProviderProfiles(t *testing.T) {
	...
	for _, name := range []string{"anthropic", "anthropic-compatible", "minimax", "deepseek", "mimo", "xiaomi", "openrouter", "volcengine", "volcengine-coding-plan", "volcengine_coding_plan"} {
