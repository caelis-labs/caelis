...
type ForkSessionRequest = gateway.ForkSessionRequest
...
type ReplayEventsRequest = gateway.ReplayEventsRequest
...
type BindingState = gateway.BindingState
type ReplayEventsResult = gateway.ReplayEventsResult
...
type Event = gateway.Event
type EventEnvelope = gateway.EventEnvelope
