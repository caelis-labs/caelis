...
func TestRecoverOperationInteractiveTerminalClosesRestartsAndRetries(t *testing.T) {
	t.Parallel()
...
func TestRecoverOperationInteractiveTerminalRequiresRestart(t *testing.T) {
	t.Parallel()
