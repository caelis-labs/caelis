...
// reconnectCompletedChild recreates only the process-local transport for an
// existing durable child. It never creates a replacement ACP Session or Task.
func (r *Runner) reconnectCompletedChild(
	ctx context.Context,
