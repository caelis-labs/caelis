...
func normalizeAgentConfig(in AgentConfig) AgentConfig {
	...
	if in.PinnedModel != nil {
		pinned := *in.PinnedModel
		pinned.ReasoningLevels = append([]string(nil), in.PinnedModel.ReasoningLevels...)
		if in.PinnedModel.ImageInput != nil {
			imageInput := *in.PinnedModel.ImageInput
			pinned.ImageInput = &imageInput
		}
