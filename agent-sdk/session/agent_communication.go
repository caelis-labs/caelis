...
// AgentCommunicationPromptFooter identifies the sender after the message body.
// Durable ActorRef values retain routing authority; this text is for the model.
func AgentCommunicationPromptFooter(actor ActorRef) string {
