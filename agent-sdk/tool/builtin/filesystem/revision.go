...
func staleRevisionError() error {
	err := tool.NewError(tool.ErrorCodeStaleRevision, "target changed since it was read")
...
func missingWriteRevisionTargetError() error {
	err := tool.NewError(tool.ErrorCodeNotFound, "target does not exist; omit if_revision to create it")
