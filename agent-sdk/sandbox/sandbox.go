...
type Session interface {
	...
	// WriteInput is available only when Status reports SupportsInput. A
	// non-interactive session must reject input instead of retaining a hidden
	// stdin pipe that can leave the command waiting indefinitely.
