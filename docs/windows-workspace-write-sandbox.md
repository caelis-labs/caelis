...
```powershell
go test ./internal/sandboxrouter ./app/gatewayapp/internal/sandboxpolicy ./impl/sandbox/host
...
```sh
go test ./internal/sandboxrouter ./app/gatewayapp/internal/sandboxpolicy ./impl/sandbox/host ./impl/sandbox/windows/...
git diff --check
```
