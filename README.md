...
SDK package boundary and ACP-native orchestration model. The current
closed/partial/open readiness verdict is in
[docs/agent-sdk-v0.25.0-acceptance.md](docs/agent-sdk-v0.25.0-acceptance.md).
