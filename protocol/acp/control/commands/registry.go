...
func DefaultSpecs() []CommandSpec {
	specs := []CommandSpec{
		...
		{Name: "plugin", Usage: "/plugin <action>", Description: "Manage Caelis plugins", LocalDuringACP: true, Details: []string{"actions: install <plugin@marketplace|path>, manage, rm <id>"}, ArgCandidates: pluginRootCandidates(), DynamicCompleter: true},
