...
func PayloadFromRuntimeRequest(req sdkruntime.ApprovalRequest) *Payload {
	payload := &Payload{
...
func RuntimeResponseFromReview(payload *Payload, result ReviewResult) sdkruntime.ApprovalResponse {
