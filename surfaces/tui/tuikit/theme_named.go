...
func nordTheme(profile colorprofile.Profile) Theme {
	return themeFrom(
		themePalette{
			...
			DiffLineNo:    profileColor(profile, "#a7b0c0", "248", "8"),
			DiffGutter:    profileColor(profile, "#4c566a", "240", "8"),
		...
		themeSurfaces{
			...
			DiffAdd:          paletteTint(profile, "#2e3440", "#a3be8c", .22),
			DiffAddStrong:    paletteTint(profile, "#2e3440", "#a3be8c", .36),
			DiffRemove:       paletteTint(profile, "#2e3440", "#bf616a", .30),
			DiffRemoveStrong: paletteTint(profile, "#2e3440", "#bf616a", .48),
		},
	)
}
...
func draculaTheme(profile colorprofile.Profile) Theme {
	return themeFrom(
		themePalette{
			...
			Muted:         profileColor(profile, "#929bb4", "247", "8"),
			...
			DiffLineNo:    profileColor(profile, "#929bb4", "247", "8"),
			DiffGutter:    profileColor(profile, "#6272a4", "61", "8"),
		...
		themeSurfaces{
			...
			Composer:         paletteTint(profile, "#282a36", "#44475a", .5),
			...
			DiffAdd:          paletteTint(profile, "#282a36", "#50fa7b", .20),
			DiffAddStrong:    paletteTint(profile, "#282a36", "#50fa7b", .32),
			DiffRemove:       paletteTint(profile, "#282a36", "#ff5555", .25),
			DiffRemoveStrong: paletteTint(profile, "#282a36", "#ff5555", .40),
		},
	)
}
