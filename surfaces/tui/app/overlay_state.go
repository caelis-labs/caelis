...
type OverlayState struct {
	...
	mentionEnd            int
	mentionLimit          int
	mentionRequestSeq     uint64
	mentionRequestQuery   string
	mentionRequestPrefix  string
	mentionRequestLimit   int
	mentionRequestPending bool
	mentionRequestCancel  context.CancelFunc
	...
	slashArgCandidateCommand  string
	slashArgCompletionSettled bool
	slashArgRequestSeq        uint64
	slashArgRequestCommand    string
	slashArgRequestQuery      string
	slashArgRequestPending    bool
	slashArgRequestCancel     context.CancelFunc
