...
export const operationIds = ["cancelSessionTurn", "closeSession", "compactSession", "createSession", "getSessionState", "getSessionStatus", "initializeClient", "listSessionTasks", "listSessions", "promptSession", "readTaskEvents", "reconnectSession", "resolveApproval", "steerSession", "subscribeTaskEvents"] as const;
