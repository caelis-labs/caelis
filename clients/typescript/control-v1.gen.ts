...
export type ConnectResult = Record<string, JSONValue>;
...
export type DisconnectCandidateList = Array<JSONObject>;

export type DisconnectResult = Record<string, JSONValue>;

export type DiscoverySnapshot = Record<string, JSONValue>;
...
export interface SetPresentationConfigRequest {
  config_id: string;
  session_id: string;
  type?: string;
  value: JSONValue;
...
export interface SetPresentationModeRequest {
  mode_id: string;
  session_id: string;
}

export interface SetPresentationModelRequest {
  model_id: string;
  session_id: string;
}
