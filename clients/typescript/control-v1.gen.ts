...
export const operationIds = ["cancelSessionTurn", "closeSession", "createSession", "getSessionState", "initializeClient", "listSessions", "promptSession", "reconnectSession", "resolveApproval", "steerSession"] as const;
