...
export const operationIds = ["cancelSessionTurn", "closeSession", "compactSession", "createSession", "getSessionState", "initializeClient", "listSessionTasks", "listSessions", "promptSession", "readTaskEvents", "reconnectSession", "resolveApproval", "steerSession", "subscribeTaskEvents"] as const;
