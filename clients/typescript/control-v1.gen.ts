...
export interface BotClientExitRequest {
  activation_id: string;
  bot_id: string;
  cancel_owned_work?: boolean;
  expected_controller_epoch?: string;
  expected_revision?: Uint64Decimal;
  operation_id?: string;
  session_id?: string;
...
export interface BotClientRegistration {
  client: BotClient;
  token: string;
}

export interface BotCompletion {
  acknowledged: boolean;
  bot_id: string;
  execution: BotExecution;
  id: string;
  principal_id: string;
  report_execution: BotExecution;
  report_state: string;
  status: string;
  summary: string;
  work_id: string;
...
export type BotCompletionList = Array<BotCompletion>;
...
export interface BotConfig {
  ...
  model?: string;
  name: string;
  work_permission?: "" | "workspace-write";
}

export interface BotDesktopArguments {
  at?: string;
  daily?: string;
...
export interface BotDesktopCall {
  action: string;
  activation_id: string;
...
export interface BotDesktopClaim {
  call: BotDesktopCall;
  token: string;
}

export interface BotDesktopReceipt {
  is_error?: boolean;
  result: unknown;
  token: string;
}

export interface BotDesktopSnapshot {
  calls: Array<BotDesktopCall>;
  cursor: string;
}

export type BotEmptyRequest = {  };
...
export interface BotReminderFire {
  bot_id: string;
  client_id: string;
  due: string;
  execution: BotExecution;
...
export type BotReminderFireList = Array<BotReminderFire>;

export interface BotReminderGrant {
  active: boolean;
  arguments: BotDesktopArguments;
  bot_id: string;
  client_id: string;
...
export type BotReminderGrantList = Array<BotReminderGrant>;

export interface BotReminderRequest {
  bot_id: string;
  due: string;
  expected_controller_epoch?: string;
  expected_revision?: Uint64Decimal;
...
export interface BotRequestSource {
  bot_id: string;
  client_id?: string;
...
export type BotWorkList = Array<BotWork>;

export interface BotWorkOperation {
  bot_id: string;
  digest: string;
  execution: BotExecution;
  operation_id: string;
...
export interface RegisterBotClientRequest {
  actions: Array<"clock" | "reminders" | "gesture">;
  bot_id: string;
  expected_controller_epoch?: string;
  expected_revision?: Uint64Decimal;
  operation_id?: string;
