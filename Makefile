...
PRODUCT_BOT_SELECTOR ?= ^(TestBotRuntimeIsolatedCapabilitiesAndStableCanonicalPrefix|TestBotRuntimeConcurrentInputCancelAndSettings|TestBotIdentityIsolationPersistenceAndLifecycle|TestBotCreationUnknownReceiptRecoversWithoutDuplicateConversation|TestBotCommittedSaveKeepsNewModelPinWhenClientCancels|TestDormantSessionRuntimeStateRecoversCanonicalOutcomeWithoutActivation)$$
