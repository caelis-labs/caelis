...
PRODUCT_BOT_SELECTOR ?= ^(TestBotNotebookToolEffectsPrefixAndContextRoundTrip|TestBotNotebookIndexDiscoverableAfterWatermarkCompaction|TestBotNotebookProvisionedOnceAtOwnerPrompt|TestBotNotebookProvisionFailureRejectsPrompt|TestBotRuntimeIsolatedCapabilitiesAndStableCanonicalPrefix|TestBotRuntimeConcurrentInputCancelAndSettings|TestBotIdentityIsolationPersistenceAndLifecycle|TestBotCreationUnknownReceiptRecoversWithoutDuplicateConversation|TestBotCommittedSaveKeepsNewModelPinWhenClientCancels|TestDormantSessionRuntimeStateRecoversCanonicalOutcomeWithoutActivation)$$
