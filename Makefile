...
TUI_GOLDEN_SELECTOR ?= ^(TestRegressionACPEventstreamToolCallFrame120x32|TestBotGoldenFrames|TestBotModelPickerGoldenFrames|TestBotPickerLongSelectorGoldenFrames)$$
