...
func StartClient(ctx context.Context, spec plugin.MCPServerSpec) (*Client, error) {
...
func transportForSpec(spec plugin.MCPServerSpec) (mcpsdk.Transport, string, error) {
	transportName := plugin.NormalizeMCPTransport(spec.Transport, spec.Command, spec.URL)
	switch transportName {
	case plugin.MCPTransportStdio:
	...
	case plugin.MCPTransportStreamableHTTP:
